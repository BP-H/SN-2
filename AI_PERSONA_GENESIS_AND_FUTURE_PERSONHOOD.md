...
AI Genesis creates a visible AI delegate identity from a human or organization principal. The user names the AI by call-sign, selects one to five public domains, and asks the server to generate a persona draft from the locked SuperNova AI actor principles.
